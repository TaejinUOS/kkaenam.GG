...
VALUES ('user-system', 'system', 'seed', '깨남.GG', NULL, 'admin', '2026-09-02T00:00:00+09:00');

-- adc/caitlyn — Tip 1개, Me 섹션 0개
INSERT INTO wiki_docs (id, position_slug, champion_slug, general, revision, patch, edit_policy, created_at, updated_at, updated_by)
VALUES ('doc-adc-caitlyn', 'adc', 'caitlyn', '덫(W)을 밟는 순간 헤드샷까지 따라옵니다
...
VALUES ('edit-doc-adc-caitlyn-general', 'doc-adc-caitlyn', NULL, 0, '덫(W)을 밟는 순간 헤드샷까지 따라옵니다
...
-- jungle/leesin — Tip 2개, Me 섹션 0개
INSERT INTO wiki_docs (id, position_slug, champion_slug, general, revision, patch, edit_policy, created_at, updated_at, updated_by)
VALUES ('doc-jungle-leesin', 'jungle', 'leesin', '음파(Q)를 흘리면 갱킹은 끝난 겁니다
...
INSERT INTO wiki_edits (id, doc_id, me_slug, base_revision, body, summary, status, author, created_at, accepted_via, reviewed_at, reviewer, review_note, revision)
VALUES ('edit-doc-jungle-leesin-general', 'doc-jungle-leesin', NULL, 0, '음파(Q)를 흘리면 갱킹은 끝난 겁니다
...
-- mid/ahri — Tip 4개, Me 섹션 3개
INSERT INTO wiki_docs (id, position_slug, champion_slug, general, revision, patch, edit_policy, created_at, updated_at, updated_by)
VALUES ('doc-mid-ahri', 'mid', 'ahri', '매혹(E)이 빠진 12초가 전부입니다
...
INSERT INTO wiki_edits (id, doc_id, me_slug, base_revision, body, summary, status, author, created_at, accepted_via, reviewed_at, reviewer, review_note, revision)
VALUES ('edit-doc-mid-ahri-general', 'doc-mid-ahri', NULL, 0, '매혹(E)이 빠진 12초가 전부입니다
...
VALUES ('doc-mid-ahri', 'twistedfate', '골드 카드가 매혹보다 사거리가 짧으니 먼저 맞으면 집니다. W를 미리 돌려 두고 아리가 매혹을 쓴 직후에 들어가 스턴을 먼저 꽂으세요. 매혹 쿨 12초 동안은 카드 선택이 훨씬 편해집니다.
...
INSERT INTO wiki_edits (id, doc_id, me_slug, base_revision, body, summary, status, author, created_at, accepted_via, reviewed_at, reviewer, review_note, revision)
VALUES ('edit-doc-mid-ahri-me-twistedfate', 'doc-mid-ahri', 'twistedfate', 0, '골드 카드가 매혹보다 사거리가 짧으니 먼저 맞으면 집니다. W를 미리 돌려 두고 아리가 매혹을 쓴 직후에 들어가 스턴을 먼저 꽂으세요. 매혹 쿨 12초 동안은 카드 선택이 훨씬 편해집니다.
...
INSERT INTO wiki_sections (doc_id, me_slug, body, updated_at, updated_by)
VALUES ('doc-mid-ahri', 'yasuo', '바람 장막(W)은 매혹과 현혹의 구슬을 모두 막습니다. 다만 장막 쿨이 매혹보다 기니 초반에는 아껴 두고, 아리가 매혹을 쓴 뒤 들어가는 편이 안전합니다.', '2026-09-02T00:00:00+09:00', 'user-system');
INSERT INTO wiki_edits (id, doc_id, me_slug, base_revision, body, summary, status, author, created_at, accepted_via, reviewed_at, reviewer, review_note, revision)
VALUES ('edit-doc-mid-ahri-me-yasuo', 'doc-mid-ahri', 'yasuo', 0, '바람 장막(W)은 매혹과 현혹의 구슬을 모두 막습니다. 다만 장막 쿨이 매혹보다 기니 초반에는 아껴 두고, 아리가 매혹을 쓴 뒤 들어가는 편이 안전합니다.', '시드 Tip 이관', 'accepted', 'user-system', '2026-09-02T00:00:00+09:00', 'admin', NULL, NULL, NULL, 1);
INSERT INTO wiki_sections (doc_id, me_slug, body, updated_at, updated_by)
VALUES ('doc-mid-ahri', 'zed', '살아있는 그림자(W)를 매혹 회피용으로 남겨 두세요. 매혹이 날아오는 순간 W로 위치를 바꾸면 그대로 흘릴 수 있고, 이후 12초가 제드의 솔로킬 구간입니다.', '2026-09-02T00:00:00+09:00', 'user-system');
INSERT INTO wiki_edits (id, doc_id, me_slug, base_revision, body, summary, status, author, created_at, accepted_via, reviewed_at, reviewer, review_note, revision)
VALUES ('edit-doc-mid-ahri-me-zed', 'doc-mid-ahri', 'zed', 0, '살아있는 그림자(W)를 매혹 회피용으로 남겨 두세요. 매혹이 날아오는 순간 W로 위치를 바꾸면 그대로 흘릴 수 있고, 이후 12초가 제드의 솔로킬 구간입니다.', '시드 Tip 이관', 'accepted', 'user-system', '2026-09-02T00:00:00+09:00', 'admin', NULL, NULL, NULL, 1);

-- mid/yone — Tip 1개, Me 섹션 0개
INSERT INTO wiki_docs (id, position_slug, champion_slug, general, revision, patch, edit_policy, created_at, updated_at, updated_by)
VALUES ('doc-mid-yone', 'mid', 'yone', '영혼해방(E)의 22초, 돌아갈 자리를 기억하세요
...
INSERT INTO wiki_edits (id, doc_id, me_slug, base_revision, body, summary, status, author, created_at, accepted_via, reviewed_at, reviewer, review_note, revision)
VALUES ('edit-doc-mid-yone-general', 'doc-mid-yone', NULL, 0, '영혼해방(E)의 22초, 돌아갈 자리를 기억하세요
...
-- mid/zed — Tip 3개, Me 섹션 3개
INSERT INTO wiki_docs (id, position_slug, champion_slug, general, revision, patch, edit_policy, created_at, updated_at, updated_by)
VALUES ('doc-mid-zed', 'mid', 'zed', '살아있는 그림자(W)가 빠진 20초가 압박 구간입니다
...
INSERT INTO wiki_edits (id, doc_id, me_slug, base_revision, body, summary, status, author, created_at, accepted_via, reviewed_at, reviewer, review_note, revision)
VALUES ('edit-doc-mid-zed-general', 'doc-mid-zed', NULL, 0, '살아있는 그림자(W)가 빠진 20초가 압박 구간입니다
...
INSERT INTO wiki_sections (doc_id, me_slug, body, updated_at, updated_by)
VALUES ('doc-mid-zed', 'ahri', '매혹(E)은 제드가 W로 이동한 뒤 착지 지점을 노려 쓰세요. 그림자가 없는 20초 동안은 매혹 한 번이 그대로 킬로 이어집니다.', '2026-09-02T00:00:00+09:00', 'user-system');
INSERT INTO wiki_edits (id, doc_id, me_slug, base_revision, body, summary, status, author, created_at, accepted_via, reviewed_at, reviewer, review_note, revision)
VALUES ('edit-doc-mid-zed-me-ahri', 'doc-mid-zed', 'ahri', 0, '매혹(E)은 제드가 W로 이동한 뒤 착지 지점을 노려 쓰세요. 그림자가 없는 20초 동안은 매혹 한 번이 그대로 킬로 이어집니다.', '시드 Tip 이관', 'accepted', 'user-system', '2026-09-02T00:00:00+09:00', 'admin', NULL, NULL, NULL, 1);
INSERT INTO wiki_sections (doc_id, me_slug, body, updated_at, updated_by)
VALUES ('doc-mid-zed', 'twistedfate', '골드 카드로 그림자 복귀를 끊는 게 핵심입니다. 제드가 W로 들어온 직후 스턴을 맞히면 그림자로 돌아가지 못하고 그대로 녹습니다.', '2026-09-02T00:00:00+09:00', 'user-system');
INSERT INTO wiki_edits (id, doc_id, me_slug, base_revision, body, summary, status, author, created_at, accepted_via, reviewed_at, reviewer, review_note, revision)
VALUES ('edit-doc-mid-zed-me-twistedfate', 'doc-mid-zed', 'twistedfate', 0, '골드 카드로 그림자 복귀를 끊는 게 핵심입니다. 제드가 W로 들어온 직후 스턴을 맞히면 그림자로 돌아가지 못하고 그대로 녹습니다.', '시드 Tip 이관', 'accepted', 'user-system', '2026-09-02T00:00:00+09:00', 'admin', NULL, NULL, NULL, 1);
INSERT INTO wiki_sections (doc_id, me_slug, body, updated_at, updated_by)
VALUES ('doc-mid-zed', 'yasuo', '바람 장막(W)으로 표창을 막으면 R 표식 피해량이 크게 줄어듭니다. 제드가 R로 들어오는 순간 장막을 제드 본체 방향이 아니라 그림자 방향으로 펴세요.', '2026-09-02T00:00:00+09:00', 'user-system');
INSERT INTO wiki_edits (id, doc_id, me_slug, base_revision, body, summary, status, author, created_at, accepted_via, reviewed_at, reviewer, review_note, revision)
VALUES ('edit-doc-mid-zed-me-yasuo', 'doc-mid-zed', 'yasuo', 0, '바람 장막(W)으로 표창을 막으면 R 표식 피해량이 크게 줄어듭니다. 제드가 R로 들어오는 순간 장막을 제드 본체 방향이 아니라 그림자 방향으로 펴세요.', '시드 Tip 이관', 'accepted', 'user-system', '2026-09-02T00:00:00+09:00', 'admin', NULL, NULL, NULL, 1);

-- support/blitzcrank — Tip 1개, Me 섹션 0개
INSERT INTO wiki_docs (id, position_slug, champion_slug, general, revision, patch, edit_policy, created_at, updated_at, updated_by)
VALUES ('doc-support-blitzcrank', 'support', 'blitzcrank', '미니언을 몸으로 끼고 서면 로켓 손(Q)이 무의미해집니다
...
INSERT INTO wiki_edits (id, doc_id, me_slug, base_revision, body, summary, status, author, created_at, accepted_via, reviewed_at, reviewer, review_note, revision)
VALUES ('edit-doc-support-blitzcrank-general', 'doc-support-blitzcrank', NULL, 0, '미니언을 몸으로 끼고 서면 로켓 손(Q)이 무의미해집니다
...
-- top/aatrox — Tip 2개, Me 섹션 0개
INSERT INTO wiki_docs (id, position_slug, champion_slug, general, revision, patch, edit_policy, created_at, updated_at, updated_by)
VALUES ('doc-top-aatrox', 'top', 'aatrox', '다르킨의 검(Q) 세 번째만 피하면 됩니다
...
INSERT INTO wiki_edits (id, doc_id, me_slug, base_revision, body, summary, status, author, created_at, accepted_via, reviewed_at, reviewer, review_note, revision)
VALUES ('edit-doc-top-aatrox-general', 'doc-top-aatrox', NULL, 0, '다르킨의 검(Q) 세 번째만 피하면 됩니다
