...
const PAGES = [
  ...
  { name: "05-matchup", path: "/matchup/ahri" },
  { name: "06-matchup-me", path: "/matchup/ahri?me=twistedfate" },
  { name: "07-history", path: "/matchup/ahri/history" },
  { name: "08-edit", path: "/matchup/ahri/edit?section=general" },
